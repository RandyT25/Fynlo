    ...
    return (
      <Card className="glass-card">
        ...
        <CardFooter className="justify-center">
          <Button variant="ghost" onClick={() => setIsMagicLink(false)}>Back to login</Button>
        </CardFooter>
      </Card>
    )
  }
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      <Card className="glass-card">
        ...
        <CardContent className="space-y-4">
          ...
          <Button variant="ghost" className="w-full text-sm" onClick={handleMagicLink} disabled={isLoading}>
